...
public class Driver_Class {
    ...
    private static void login(String user_passed) throws InterruptedException, IOException {
        ...
        for (;;) {
            ...
            if ("STAFF".equals(user_passed)) {
                ...
                //The administrator has the rights to access the PVMS.
                admin_menu();
            }
        }
    }
    ...
    private static void check_balance() {//To change body of generated methods, choose Tools | Templates.
    }

    private static void un_parkcar() { //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private static void view_status() {
        ...
        int s = loggedStaff.size()-1;
        System.out.println("Surname     : " + loggedStaff.get(s).getUsername());
        System.out.println("Parking bay : " + loggedStaff.get(s).getParking_space());
        
        for (int i = 0; i < Parking_list.size(); i++) {
            if ( loggedStaff.get(s).getParking_space().equals(Parking_list.get(i).getName()) ) {
                System.out.println("Car parked : " + Parking_list.get(i).getCarParked());
            }
        }
    }
